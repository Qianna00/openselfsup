...
# train
python tools/extract_backbone_weights.py /root/data/zq//marvel_cls/selfsup/moco400k_epoch_80.pth \
/root/data/zq/marvel_cls/selfsup/pretrained_res50_400k_80.pth
