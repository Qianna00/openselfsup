...
register_coco_instances("smd_train", {}, "/root/data/zq/data/SMD/annotations/Training/SMD_VIS_skip_10_train.json",
                        "/root/data/zq/data/SMD/train")
register_coco_instances("smd_val", {}, "/root/data/zq/data/SMD/annotations/Training/SMD_VIS_skip_10_val.json",
                        "/root/data/zq/data/SMD/train")
...
def setup(args):
    ...
    cfg.OUTPUT_DIR = "/root/data/zq/smd_det/marvel_finetuned_det_10c/faster_rcnn"
